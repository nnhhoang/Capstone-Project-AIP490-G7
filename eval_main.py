...
from python_algo.semantic import Semantic_eval
import json


data_in_path = r"data\question_data.csv"
database_path = r"data\question_data_full.csv"
data_in = pd.read_csv(r'data\question_data.csv')
...
for row in data_in.itertuples():
    ...
    ranking_result, final_result, metadata = question_database.new_ranking_question(question_main,k=len(data_base))
    cost += cost_in_out(metadata=metadata)
